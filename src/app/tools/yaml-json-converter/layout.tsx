...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "YAML ↔ JSON Converter";
    const description = "Convert between YAML and JSON formats bidirectionally";
    const toolId = "yaml-json-converter";
    const category = "Data Converters";
    const tags = ["yaml", "json", "convert", "config", "transform"];
