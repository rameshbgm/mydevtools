...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "HTML Entities Encoder";
    const description = "Encode and decode HTML entities and special characters";
    const toolId = "html-entities";
    const category = "Encoding & Decoding";
    const tags = ["html", "entities", "encode", "decode", "escape"];
