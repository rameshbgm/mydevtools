...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "HMAC Generator";
    const description = "Generate HMAC signatures using SHA-1, SHA-256, SHA-384, SHA-512 algorithms";
    const toolId = "hmac-generator";
    const category = "Cryptography";
    const tags = ["hmac", "sha", "signature", "auth", "hash", "security", "digest"];
