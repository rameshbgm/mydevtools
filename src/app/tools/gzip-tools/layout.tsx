...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "Gzip Compress / Decompress";
    const description = "Compress and decompress text using Gzip with Base64 encoding";
    const toolId = "gzip-tools";
    const category = "Encoding & Decoding";
    const tags = ["gzip", "compress", "decompress", "zip", "deflate"];
