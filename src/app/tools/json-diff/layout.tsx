...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "JSON Diff";
    const description = "Compare two JSON documents side by side with highlighted differences";
    const toolId = "json-diff";
    const category = "Diff & Compare";
    const tags = ["json", "diff", "compare"];
