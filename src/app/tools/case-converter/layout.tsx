...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "String Case Converter";
    const description = "Convert text between camelCase, snake_case, PascalCase, kebab-case and more";
    const toolId = "case-converter";
    const category = "Text & Utilities";
    const tags = ["case", "camel", "snake", "pascal", "kebab", "convert", "string"];
