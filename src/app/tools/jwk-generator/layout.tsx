...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const toolName = "JWK Generator";
    const description = "Generate JSON Web Keys (JWK) for RSA, EC, and symmetric algorithms";
    const toolId = "jwk-generator";
    const category = "Cryptography";
    const tags = ["jwk", "key", "generate", "jose", "rsa", "ec", "symmetric"];
