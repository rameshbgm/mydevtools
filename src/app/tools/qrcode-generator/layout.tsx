...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const description = "Generate QR codes from text, URLs, or data with customization options";
    const toolId = "qrcode-generator";
    const category = "Generators";
    const tags = ["qr", "qrcode", "barcode", "generate", "scan"];
